...
def get_KD_at_Jmax_3(efflux_data, KD_axis):
    ''' 
    NUMERICALLY GET THE KD VALUE AT JMAX FOR EACH PROTON CONCENTRATION, UNICYCLIC
    
    GENERATE MATRIX TO USE AS THE ARGUMENT efflux_data USING THE FUNCTION efflux_matrix_3.
...
def plot_KD_at_Jmax_3(param, KD_axis, Kp, V_base, kappa, cDc_vals, cpp_axis, filename):
    ''' PLOT KD AT Jmax FOR THE THREE STATE MODEL FOR THE PARAMETER VALUES SPECIFIED '''
    ...
    KD_at_Jmax = get_KD_at_Jmax_3(J, KD_axis)
...
plot_KD_at_Jmax_3(param, KD_axis, Kp, V_base, kappa, cDc_vals, cpp_axis, "dummy_data3")
